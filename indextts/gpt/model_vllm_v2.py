...
class UnifiedVoice(nn.Module):
    def __init__(self, vllm_model,
                 ...
                 start_text_token=0, stop_text_token=1, number_mel_codes=8194, start_mel_token=8192,
                 stop_mel_token=8193,
        ...
        del self.gpt.wte
        self.mel_pos_embedding, self.text_pos_embedding = LearnedPositionEmbeddings(max_mel_seq_len,
                                                                                    model_dim), LearnedPositionEmbeddings(
        ...
        self.sampling_params = SamplingParams(
            temperature=1.0,  # preview 1.0
            top_p=0.8,  # preview 0.8
            top_k=50,  # 5, 30 preview 30
            repetition_penalty=5.0,  # 8.0  preview 10
            max_tokens=2048,  # 605
    ...
    async def inference_speech(self, speech_condition, text_inputs, emo_speech_condition=None, cond_lengths=None,
                               emo_cond_lengths=None, emo_vec=None, use_speed=False):
        ...
        mel_start_emb = self.mel_embedding(
            torch.full((emb.shape[0], 1,), fill_value=self.start_mel_token, dtype=torch.long,
